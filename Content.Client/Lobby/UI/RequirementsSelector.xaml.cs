...
public sealed partial class RequirementsSelector : BoxContainer
{
    ...
    public ICharacterProfile? selectedProfile; // EE: Job Preferences
    ...
    // EE: Job Preferences, setup with character preferences
    public void SetupWithPreferences(
        (string, int)[] items,
        string title,
        int titleSize,
        string? description,
        ...
        List<ProtoId<GuideEntryPrototype>>? guides = null)
    {
        foreach (var (text, value) in items)
            _options.AddItem(Loc.GetString(text), value);
        _options.Margin = new Thickness(5f, 0f, 5f, 0f);
        ...
        OptionsContainer.SeparationOverride = 12;
        OptionsContainer.AddChild(_options);
        OptionsContainer.AddChild(_lockStripe);
    ...
    private Button GenerateButton(string text, int value)
    {
        return new Button
        {
            ...
            MinWidth = 90,
            HorizontalExpand = true,
            Margin = new Thickness(10, 0, 10, 0), // WHY ARE THEY STILL NEARBY?!
        };
    }
