...
namespace Content.Client.Lobby
{
    public sealed class LobbyState : Robust.Client.State.State
    {
        ...
        protected override void Startup()
        {
            ...
            Lobby.CharacterPreview.JobPreferencesButton.OnPressed += OnPreferencesPressed; // EE: Job Preferences
        ...
        // EE: Job Preferences
        private void OnPreferencesPressed(BaseButton.ButtonEventArgs args)
        {
            SetReady(false);
            Lobby?.SwitchState(LobbyGui.LobbyGuiState.JobPreferences);
        }
